...
function Success({ userEmail }) {
  ...
  return (
    <div className="flex h-[875px] w-[100dvw] flex-col bg-frontend-white p-10 leading-[1] md:h-[48dvh] md:w-[34dvw] md:gap-8 md:rounded-[32px] md:p-20 md:shadow-2xl md:shadow-dark-slate-grey">
      <img
