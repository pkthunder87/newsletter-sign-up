...
function SignUp({ setUserEmail }) {
  return (
    <div className="grid h-[875px] w-[100dvw] grid-cols-1 bg-frontend-white  pt-0 md:h-[64rem] md:w-[92.5rem] md:grid-cols-[50%_50%] md:overflow-auto md:rounded-[35px] md:px-8 md:shadow-[0_35px_80px_30px_rgba(0,0,0,.25)]">
